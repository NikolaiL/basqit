...
const Notification = ({
  ...
  return toast.custom(
    (t: Toast) => (
      <div
        className={`bq-toast flex flex-row items-start justify-between max-w-sm p-4 transform-gpu relative transition-all duration-500 ease-in-out space-x-2
        ${
